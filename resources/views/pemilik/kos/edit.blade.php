...
@section('content')
    <div class="space-y-6">
        ...
        <!-- Header -->
        <div
            class="bg-gradient-to-r from-primary-900/30 to-indigo-900/30 border border-primary-800/30 rounded-2xl p-6 mb-6">
        ...
        <div class="bg-dark-card border border-dark-border rounded-2xl p-6">
            <form method="POST" action="{{ route('pemilik.kos.update', $kos->id_kos) }}" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="3"
                                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition"
                                    id="alamatInput" required>{{ old('alamat', $kos->alamat) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="kecamatan" value="{{ old('kecamatan', $kos->kecamatan) }}"
                                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition"
                                    id="kecamatanInput" required maxlength="100">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="kota" value="{{ old('kota', $kos->kota) }}"
                                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition"
                                    id="kotaInput" required maxlength="100">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="provinsi" value="{{ old('provinsi', $kos->provinsi) }}"
                                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition"
                                    id="provinsiInput" required maxlength="100">
                            </div>
                    ...
                    <div class="border-b border-dark-border pb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="longitude" id="longitude"
                                    ...
                                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition"
                                    placeholder="106.845599" readonly>
                            </div>
                        </div>
                        ...
                        <div class="bg-primary-900/20 border border-primary-800/30 rounded-xl p-4">
                            <div class="flex items-start space-x-3">
                                <div
                                    class="w-8 h-8 bg-primary-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @else
                                    <div
                                        class="w-full h-64 bg-dark-bg border-2 border-dashed border-dark-border rounded-xl flex flex-col items-center justify-center">
                            ...
                            <div>
                                ...
                                <div
                                    class="border-2 border-dashed border-dark-border rounded-xl p-6 hover:border-primary-500 transition group">
                                    <div class="text-center">
                                        <div
                                            class="w-16 h-16 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                ...
                <!-- Action Buttons -->
                <div
                    class="mt-8 pt-8 border-t border-dark-border flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('pemilik.kos.index') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Track manual edits
            const formInputs = document.querySelectorAll('#alamatInput, #kecamatanInput, #kotaInput, #provinsiInput, #kodePosInput');
            ...
            function updateAddressFields(address) {
                ...
                // Update alamat
                if (!alamatInput.dataset.manualEdit) {
                    const alamat = [
