...
@section('title', 'Edit Profil - Pemilik Kos')
...
@section('content')
    <div class="p-4 md:p-6">
        ...
        <div class="bg-dark-card border border-dark-border rounded-2xl overflow-hidden">
            <form action="{{ route('pemilik.profile.update') }}" method="POST" class="p-6 md:p-8"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama', $pemilik->nama) }}"
                        ...
                        <div>
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin"
                                class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition appearance-none">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                    value="{{ old('tanggal_lahir', $pemilik->tanggal_lahir ? \Carbon\Carbon::parse($pemilik->tanggal_lahir)->format('Y-m-d') : '') }}"
                                    class="w-full pl-10 pr-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition">
                            </div>
                            @error('tanggal_lahir')
                                <p class="text-red-400 text-sm mt-2">{{ $message }}</p>
                ...
                <div class="mb-8">
                    <h3
                        class="text-lg md:text-xl font-semibold text-white mb-6 pb-4 border-b border-dark-border flex items-center">
                        <i class="fas fa-address-book text-primary-400 mr-3"></i>
                        Data Kontak
                    </h3>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $pemilik->email) }}"
                                    class="w-full pl-10 pr-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp', $pemilik->no_hp) }}"
                                    class="w-full pl-14 pr-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
                        ...
                        <div>
                            ...
                            <textarea id="alamat" name="alamat" rows="3"
                                class="w-full px-4 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition resize-none"
                                placeholder="Alamat lengkap tempat tinggal">{{ old('alamat', $pemilik->alamat) }}</textarea>
                            @error('alamat')
                                <p class="text-red-400 text-sm mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mb-8">
                    <h3
                        class="text-lg md:text-xl font-semibold text-white mb-6 pb-4 border-b border-dark-border flex items-center">
                        <i class="fas fa-money-check-alt text-primary-400 mr-3"></i>
                        Data Rekening Bank
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Nama Bank -->
                        <div>
                            <label for="nama_bank" class="block text-sm font-medium text-white mb-2">
                                Nama Bank
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <!-- Nomor Rekening -->
                        <div>
                            <label for="nomor_rekening" class="block text-sm font-medium text-white mb-2">
                                Nomor Rekening
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div class="mb-8">
                    ...
                    <!-- Security Info -->
                    <div class="bg-primary-900/20 border border-primary-800/30 rounded-xl p-5 mb-6">
                        <div class="flex items-start">
                            <i class="fas fa-info-circle text-primary-400 text-lg mr-3 mt-0.5"></i>
                            <div>
                                <h4 class="font-semibold text-white mb-1">Ubah Password</h4>
                                <p class="text-primary-200 text-sm">Kosongkan kolom password jika tidak ingin mengubah
                                    password Anda.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password" name="password"
                                    class="w-full pl-10 pr-10 py-3 bg-dark-bg border border-dark-border text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <button type="submit"
                            class="px-8 py-3 bg-gradient-to-r from-primary-500 to-indigo-500 text-white rounded-xl hover:from-primary-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 inline-flex items-center justify-center">
