...
@section('title', 'Riwayat Pembayaran - Kosan App')
...
<div class="space-y-6">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="inline-flex items-center">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('penghuni.pembayaran.index') }}" class="inline-flex items-center text-sm font-medium text-dark-muted hover:text-white transition-colors">
    ...
    <div class="bg-dark-card border border-dark-border rounded-2xl p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-dark-bg/50 border border-dark-border rounded-xl p-5 hover:border-blue-500/50 transition-all duration-300">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-white">Rp {{ number_format($kontrak->harga_sewa, 0, ',', '.') }}/bulan</p>
                        </div>
                    </div>
    ...
    <div class="bg-dark-card border border-dark-border rounded-2xl overflow-hidden">
                    ...
                    <tr class="hover:bg-dark-bg/30 transition-colors">
                        <td class="px-6 py-4">
                            <div>
                                ...
                                <div class="mt-1">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-orange-900/30 text-orange-300">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-900/30 text-blue-300 capitalize">
                                <i class="fas 
                                    {{ $bayar->metode_pembayaran == 'transfer' ? 'fa-university' : 
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                ...
                                <i class="fas 
                                    {{ $bayar->status_pembayaran == 'lunas' ? 'fa-check-circle' : 
        ...
        <div class="text-center py-12">
            <div class="w-16 h-16 bg-dark-bg border border-dark-border rounded-full flex items-center justify-center mx-auto mb-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        ...
        <div class="bg-dark-card border border-dark-border rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-300 card-hover">
        ...
        <!-- Cara Pembayaran -->
        <div class="bg-dark-card border border-dark-border rounded-2xl p-6 hover:border-blue-500/50 transition-all duration-300 card-hover">
            <div class="flex items-center mb-4">
