                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex flex-col items-center">
                            <div>
                                class="w-24 h-24 md:w-32 md:h-32 rounded-full border-2 border-dark-border overflow-hidden bg-gradient-to-br from-green-900/30 to-emerald-900/30 flex items-center justify-center">
                                @if($penghuni->foto_profil)
                                    <img src="{{ Storage::url($penghuni->foto_profil) }}" alt="{{ $penghuni->nama }}"
                        ...
                        <div class="flex-1">
                            <div
                                class="border-2 border-dashed border-dark-border rounded-2xl p-6 text-center hover:border-green-500/50 transition-colors">
                                <div class="mb-4">
